...
bool DS3231_SetAlarm_one_sec (void){
  
  uint8_t alarmSecond = 0x80;
  uint8_t alarmMinute = 0x80;
  uint8_t alarmHour = 0x80;
  uint8_t alarmDate = 0x80;
...
bool DS3231_SetAlarm_one_min (void){
  ...
  if(HAL_I2C_Master_Transmit(i2c, DS3231_ADDR, buffer, sizeof(buffer), HAL_MAX_DELAY) != HAL_OK) return false;
    ...
    /* Enable Alarm2 at Control Register */
  uint8_t ctrlReg = 0x00;
  ReadRegister(DS3231_REG_CONTROL, &ctrlReg);
